...
import com.example.FoodApp.cart.service.CartServiceImpl;
...
//clear the users cart after the order is placed
    ...
    public Response<Long> countUniqueCustomers() {
        ...
        log.info("Inside countUniqueCustomer()");

        long UniqueCustomerCount = orderRepository.countDistinctUsers();
        return Response.<Long>builder()
                .statusCode(HttpStatus.OK.value())
                .message("Unique customer count retrived successfully")
    ...
    private void sendOrderConfirmationEmail(User customer, OrderDTO orderDTO){
        ...
        Context context= new Context(Local.getDefault());
        ...
        context.setVarible("deliveryAddress", deliveryAddress);
        ...
        String paymentLink= basePaymentLink +orderDTO.getId() +"&amount="+ oderDTO.getTotalAmount();
